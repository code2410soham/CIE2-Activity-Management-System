 ...
 * File: backend/import_students.js
 * Purpose: Connects to local MySQL database, processes database/students.json, hashes passwords and imports data.
 */
...
async function main() {
    ...
    try {
        ...
        // Clear existing mock student users to avoid conflicts
        ...
        for (let index = 0; index < students.length; index++) {
            ...
            await connection.query(
                'INSERT INTO student_profiles (id, user_id, name, usn, department_id, current_semester_id, admission_year, section) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
