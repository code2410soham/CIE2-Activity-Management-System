...
<head>
    ...
    <title>Quizzes | CIE-2 Portal</title>
...
<body data-theme="dark">
    ...
    <div class="app-layout">
        <aside class="sidebar" id="sidebar">
            <!-- Exact same sidebar as others but active on Quizzes -->
        ...
        <main class="main-wrapper">
            <header class="topbar">
                <div class="topbar-left">
                    <h2 class="outfit-font">My Quizzes</h2>
                </div>
            ...
            <div class="content-scroll" id="quiz-list-view">
                <!-- Grid for Quiz Cards -->
                <div class="kpi-grid animate-enter delay-100" id="quizzes-deck">
                    <div style="text-align:center; padding:40px; grid-column:1/-1;">Loading Quizzes...</div>
                </div>
            </div>

            <div class="content-scroll hidden animate-enter" id="quiz-attempt-view" style="display:none;">
                <div class="glass-panel">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 30px;">
                        <h2 class="outfit-font" id="active-quiz-title">Quiz Title</h2>
                        <div style="font-size: 1.2rem; font-weight:700; color:var(--brand-rose);" id="quiz-timer">00:00
                        </div>
                    </div>

                    <div id="questions-container"
                        style="display:flex; flex-direction:column; gap:24px; margin-bottom: 30px;">
                        <!-- Questions injected here -->
                    </div>

                    <div style="display:flex; justify-content:space-between;">
                        <button class="btn btn-outline" onclick="cancelQuiz()">Cancel</button>
    ...
    <script src="quizzes.js?v=3.0"></script>
    <script>
