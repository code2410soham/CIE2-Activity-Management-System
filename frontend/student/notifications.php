...
<head>
    ...
    <title>Notifications | CIE-2 Portal</title>
    ...
    <main class='main-wrapper'>
        <header class='topbar'>
            <div class='topbar-left'>
                <h2 class='outfit-font'>Notifications</h2>
            </div>
        </header>

        <div class='content-scroll'>
            <div class="glass-panel"><div id="notif-list" style="display:flex; flex-direction:column; gap:16px;">Loading...</div></div>
        </div>
    </main>
</div>
