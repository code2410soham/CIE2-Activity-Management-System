...
<head>
    ...
    <title>Manage Submissions | CIE-2 Portal</title>
...
<div class='app-layout'>
    <aside class='sidebar' id='sidebar'>
        ...
        <nav class='sidebar-nav'>
            ...
            <a href='submissions.php' class='nav-item active'>Submissions</a>
    ...
    <main class='main-wrapper'>
        <header class='topbar'>
            <div class='topbar-left'>
                <h2 class='outfit-font'>Manage Submissions</h2>
            </div>
        </header>

        <div class='content-scroll'>
            <div class="glass-panel"><table class="modern-table"><thead><tr><th>Student</th><th>Activity</th><th>Status</th><th>File</th></tr></thead><tbody id="subs-body"></tbody></table></div>
        </div>
    </main>
</div>
